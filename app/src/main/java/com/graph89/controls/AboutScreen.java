...
public class AboutScreen
{
	...
	public void Show() {
		...
		// @formatter:off
		String text =
				"\nThis application relies on open-source code. Details and licensing can be found at the web links below.\n\n\n\n" +

				"Advanced Calculator - Version: " + BuildConfig.VERSION_NAME + "\n\n" +
				"Copyright \u00A9 2026, Laven Franklin\n" +
				"http://github.com/LFranklinApps/AdvancedCalculator\n\n\n\n" +

				"PedroM - Version: 0.83\n\n" +
				"Copyright \u00A9 2003-2010, Patrick Pelissier\n" +
				"http://www.ticalc.org/archives/files/fileinfo/319/31951.html\n\n\n\n" +

				"Graph 89 - Version: " + "1.2.0" + "\n\n" +
				"Copyright \u00A9 2012-2013, Dritan Hashorva\n" +
				"Copyright \u00A9 2021, Micha LaQua\n" +
				"Copyright \u00A9 2024-2026, E. Anema\n" +
				"http://github.com/eanema/graph89/\n\n\n\n" +
